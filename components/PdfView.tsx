...
export const PdfView: React.FC<Props> = ({ 
  ...
  const handlePdfClick = (type: 'FREE' | 'PREMIUM' | 'ULTRA') => {
      ...
      // Subscription Check REMOVED for Pay-Per-View Model
      // User said "Jo chijhe paid hai unko 1st time use karte time cradit katega... bas 1 baar katega phir ho kifetime unlocked"
      // THEN CHANGED TO: "user jo bhi chijh dekhega jab jab dekhega tab tab cradit katenge"
      // So we force payment flow unless Admin.
